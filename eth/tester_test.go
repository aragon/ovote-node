...
func TestAdvanceBlock(t *testing.T) {
	...
	c.Assert(processes[0].ResultsPublishingWindow, qt.Equals, events[1001][0].ResultsPublishingWindow)
	...
	c.Assert(processes[1].ResultsPublishingWindow, qt.Equals, events[1002][0].ResultsPublishingWindow)
